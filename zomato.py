...
garamond_bold_style = "font-family: Garamond, sans-serif; font-weight: bold; color:green; font-size: 30px;"
garamond_bold_style2 = "font-family: Garamond, sans-serif; font-weight: bold; color: red; font-size: 25px;"

data = pd.read_csv(r'C:\Users\shama\cleaned_zomato_dataset.csv')    
...
def main():
    ...
    with st.sidebar:
        selected = option_menu("Menu", ["Charts","Report"],
                    icons=["graph-up-arrow","file"],
    ...
    if selected == 'Charts':
        ...
        fig = px.scatter_mapbox(filtered_data, 
                        ...
                        color_discrete_map={'Average Cost for two':'fuchsia'}
                        )
        fig.update_layout(
